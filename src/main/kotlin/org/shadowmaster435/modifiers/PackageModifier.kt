...
object PackageModifier : Modifier {
    ...
    override val chainableWith = listOf(AbstractModifier::class.java, OverrideModifier::class.java, MetaModifier::class.java, OpenModifier::class.java,
        ExternalModifier::class.java)
}