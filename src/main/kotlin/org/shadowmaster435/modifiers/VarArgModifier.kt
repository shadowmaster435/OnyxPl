...
object VarArgModifier : Modifier {
    override val modifierScopes: List<ModifierScope> = listOf(ModifierScope.FUNCTION_PARAM, ModifierScope.CONSTRUCTOR_PARAM)
    override val chainableWith = listOf(FinalModifier::class.java, PublicModifier::class.java, ProtectedModifier::class.java,
        PrivateModifier::class.java)
}