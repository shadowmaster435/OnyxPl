...
abstract class OnyxDiv(leftType: OnyxType, rightType: OnyxType, retType: OnyxType) : OnyxBinaryOperator(leftType, rightType, retType) {
    override val precedence = 9
    override fun toString() = "/"

    class ByPrimitiveNumber : OnyxDiv(numberType, numberType, numberType) {
    ...
    companion object {
        fun create(left: DataProvider, right: DataProvider): OnyxDiv {
