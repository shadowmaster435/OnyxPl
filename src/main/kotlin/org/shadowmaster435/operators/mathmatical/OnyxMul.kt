...
abstract class OnyxMul(leftType: OnyxType, rightType: OnyxType, retType: OnyxType) : OnyxBinaryOperator(leftType, rightType, retType) {
    override val precedence = 9
    override fun toString() = "*"

    class ByPrimitiveNumber : OnyxMul(numberType, numberType, numberType) {
